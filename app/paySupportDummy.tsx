...
export default function paySupport(){
  const currentOfferingValue = { availablePackages:  [ 
    {product: {title:'応援をする', price:200, identifier:'button2speak'} },
    {product: {title:'確かな応援', price:500, identifier:'button2speak2'}},
    {product: {title:'十分な応援', price:1000, identifier:'button2speak3'}}, 
  ] }
  const [currentOffering, setCurrentOffering] = useState(currentOfferingValue);
  const custProd =  [ 'button2speak', 'button2speak2','button2speak3'  ]
